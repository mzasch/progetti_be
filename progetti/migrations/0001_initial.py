# Generated by Django 3.1.1 on 2020-10-20 07:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docente_fs', models.OneToOneField(help_text='Docente incaricato per questa FS', on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL, verbose_name='Docente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_referente', models.ForeignKey(help_text='Docente responsabile del progetto', on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL, verbose_name='Docente referente')),
                ...
                ('materiali', models.ManyToManyField(to='progetti.Materiale')),
            ],
            options={
